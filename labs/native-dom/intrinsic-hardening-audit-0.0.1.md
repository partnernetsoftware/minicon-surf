...
flowchart TD
  ...
  P -.->|"resisted at the time -- see the note"| PF["activation preflight (2.4)"]
  %% Correction, 2026-09-06: the label read "resisted: the host re-checks the
  %% node kind", and that was false when this was written --
