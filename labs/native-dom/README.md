...
`isTrusted` is false everywhere, because these events are synthesized by an
agent; `timeStamp` reads the clock the realm already had. Losses: listener
